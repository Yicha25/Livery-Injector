...
Paste the Code: Delete any default text and paste the entire Livery-Injector-AircraftRecord-Aware.js code.

Save: Press Ctrl+S or click File > Save.

### How to Use
1. Opening the Menu
Once the game loads, look for the Livery Icon (located in the bottom UI bar near the camera/map buttons). Click it to toggle the control panel.

2. Adding a Livery
Spawn in the aircraft you want to customize (e.g., the Boeing 737).

Open the Livery Cloud panel.

Click "Choose File" and select a texture image (.png or .jpg) from your computer.

Click "SAVE FOR THIS PLANE".
...
4. Backups
Export: Click the EXPORT button to download a file containing all your saved textures.

Import: Use the IMPORT button to restore a previously saved backup file.

Wipe: Use the WIPE button to clear all data and reset the database (Warning: This cannot be undone).
